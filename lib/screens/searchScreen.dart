...
import 'package:tourism_app/screens/onboarding_screen/content_model.dart';
import 'package:tourism_app/utils/viewphotoonsearch.dart';
...
class _searchScreenState extends State<searchScreen> {
  ...
  void addData() {
    ...
    suggestedPostList.add(SuggestedPostModel(false, "assets/images/search/6.jpg",
        "assets/images/search/8.jpg", "assets/images/search/4.jpg"));
    suggestedPostList.add(SuggestedPostModel(false, "assets/images/search/1.jpg",
